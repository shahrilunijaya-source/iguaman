...
<head>
    ...
    <style>
        ...
        .daftar-wrap { display: flex; justify-content: center; padding: 32px 20px 0; }
        .daftar-card { width: 100%; max-width: 860px; padding-bottom: 110px; }
        .daftar-head { margin-bottom: 18px; }

        /* ---- Intro / "what you'll need" panel (echoes login pine accent) ---- */
        .daftar-intro {
            background: var(--pine-deep); color: #fff;
            border-radius: var(--r-lg); padding: 20px 22px; margin: 20px 0 8px;
        ...
        .daftar-intro__h { font-size: 17px; font-weight: 700; margin: 0 0 10px; }
        .daftar-intro__grid { display: grid; grid-template-columns: 1fr 1fr; gap: 6px 22px; }
        .daftar-intro__item { display: flex; gap: 8px; align-items: flex-start; font-size: 12.5px; line-height: 1.5; color: rgba(255,255,255,0.78); }
        .daftar-intro__item svg { flex-shrink: 0; margin-top: 2px; color: var(--teal); }
        .daftar-intro__note { margin-top: 14px; padding-top: 12px; border-top: 1px solid rgba(255,255,255,0.12); font-size: 11.5px; color: rgba(255,255,255,0.6); }
        ...
        .daftar-actions__back { color: var(--mute); text-decoration: none; font-size: 12px; }
        .daftar-actions__back:hover { color: var(--pine); }
    ...
    <div class="daftar-card">
        ...
        @else
            ...
            <div class="swap__screen daftar-head">
                ...
                <p class="vb-sub" style="margin-bottom: 0;">Lengkapkan borang di bawah untuk memohon menyertai panel Bantuan Guaman.</p>
            </div>
            ...
            <div class="daftar-intro">
                ...
                <p class="daftar-intro__note">Medan bertanda <span class="req" style="color: var(--orange);">*</span> wajib diisi. Borang ini panjang — luangkan kira-kira 10 minit.</p>
            </div>
            ...
            <form method="POST" action="{{ route('peguam.daftar.store') }}" class="va-form" style="margin-top: 18px;" enctype="multipart/form-data" id="daftarForm">
                @csrf
                ...
                <div class="daftar-grid">
                    ...
                    <div class="field col-2">
                        ...
                        <input type="file" name="senaraiKesKendali" class="field__input" accept=".pdf" required style="padding:9px 14px; height:auto;">
                    </div>
                </div>
                ...
                <div class="daftar-grid">
                    ...
                    <div class="field">
                        ...
                        <input type="file" name="clp" class="field__input" accept=".pdf" style="padding:9px 14px; height:auto;">
                    </div>
                    <div class="field">
                ...
                <div class="daftar-grid">
                    ...
                    <div class="field">
                        ...
                        <input type="file" name="certkelulusanYBGK" class="field__input" accept=".pdf" style="padding:9px 14px; height:auto;">
                    </div>
                </div>
                    ...
                    <div class="cso-block {{ $i > 1 && ! $csoHasOld ? 'is-collapsed' : '' }}" data-cso-block="{{ $i }}">
                        ...
                        <div class="daftar-grid">
                            ...
                            <div class="field col-2">
                                ...
                                <input type="file" name="cso{{ $i }}" class="field__input" accept=".pdf" style="padding:9px 14px; height:auto;">
                            </div>
                        </div>
                    </div>
                @endforeach
                ...
                <div class="daftar-grid">
                    <div class="field">
                        ...
                        <input type="file" name="certpenimbangtara" class="field__input" accept=".pdf" style="margin-top:8px; padding:9px 14px; height:auto;">
                    ...
                    <div class="field">
                        ...
                        <input type="file" name="certpengantara" class="field__input" accept=".pdf" style="margin-top:8px; padding:9px 14px; height:auto;">
                ...
                <div class="daftar-grid">
                    ...
                    <div class="field col-2">
                        ...
                        <input type="file" name="sijilEvendor" class="field__input" accept=".pdf" style="padding:9px 14px; height:auto;">
                    </div>
                </div>
                ...
                <div class="daftar-grid">
                    ...
                    <div class="field col-2">
                        ...
                        <input type="file" name="profilFirma" class="field__input" accept=".pdf" style="padding:9px 14px; height:auto;">
                    </div>
                    <div class="field col-2">
                ...
                <div class="daftar-grid">
                    ...
                    <div class="field">
                        ...
                        <input type="file" name="insuransTR" class="field__input" accept=".pdf" style="padding:9px 14px; height:auto;">
                    </div>
                    <div class="field">
                ...
                <div class="daftar-grid">
                    ...
                    <div class="field col-2">
                        ...
                        <input type="file" name="penyataBank" class="field__input" accept=".pdf" style="padding:9px 14px; height:auto;">
                    </div>
                    <div class="field col-2">
                ...
                <div class="daftar-grid">
                    <div class="field">
                        ...
                        <input type="file" name="kadPengenalan" class="field__input" accept=".pdf" required style="padding:9px 14px; height:auto;">
                    </div>
                    <div class="field">
                        <label class="field__label">Sijil Akademik 1 (PDF)</label>
                        <input type="file" name="sijilAkademik1" class="field__input" accept=".pdf" style="padding:9px 14px; height:auto;">
                    </div>
                    <div class="field">
                        <label class="field__label">Sijil Akademik 2 (PDF)</label>
                        <input type="file" name="sijilAkademik2" class="field__input" accept=".pdf" style="padding:9px 14px; height:auto;">
                    </div>
                    <div class="field">
                        <label class="field__label">Sijil Akademik 3 (PDF)</label>
                        <input type="file" name="sijilAkademik3" class="field__input" accept=".pdf" style="padding:9px 14px; height:auto;">
                    </div>
                </div>

                <div class="daftar-actions">
                    <a href="{{ route('system.login') }}" class="daftar-actions__back">← Kembali ke log masuk</a>
...
<script>
    // Progressive disclosure for Sijil Peguam Syarie 2–5: reveal one block per click.
    (function () {
        var addBtn = document.getElementById('csoAdd');
        if (!addBtn) return;

        function nextHidden() {
            return document.querySelector('.cso-block.is-collapsed');
        }
        function sync() {
            if (!nextHidden()) addBtn.style.display = 'none';
        }
        addBtn.addEventListener('click', function () {
            var blk = nextHidden();
            if (blk) {
                blk.classList.remove('is-collapsed');
                blk.querySelector('input, select')?.focus();
            }
            sync();
        });
        sync(); // hide the button if validation already expanded all blocks
    })();
</script>
