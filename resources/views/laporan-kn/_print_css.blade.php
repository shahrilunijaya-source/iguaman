...
<style>
    ...
    .lkn-table th { text-align: left; padding: 8px 10px; border-bottom: 2px solid var(--line, #dde5e3); color: var(--pine-deep, #003D3A); font-size: 11px; text-transform: uppercase; letter-spacing: .4px; white-space: nowrap; }
