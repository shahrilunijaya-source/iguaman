...
<head>
    ...
    <style>
        ...
        * { font-family: 'DejaVu Sans', sans-serif; }
        ...
        header { position: fixed; top: -52px; left: 0; right: 0; height: 44px; border-bottom: 2px solid #0d2e48; }
        .brand { font-size: 14px; font-weight: bold; color: #0d2e48; }
        ...
        h1 { font-size: 13px; color: #0d2e48; margin: 0 0 2px; }
        .meta { color: #666; font-size: 8.5px; margin-bottom: 10px; }
        table { width: 100%; border-collapse: collapse; }
        th { background: #0d2e48; color: #fff; text-align: left; padding: 5px 6px; font-size: 8px; text-transform: uppercase; letter-spacing: .3px; }
