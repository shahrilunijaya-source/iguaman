...
<style>
    ...
    .ag-tab.is-active { background:var(--brand,#1a6fa8); color:#fff; border-color:var(--brand,#1a6fa8); }
    ...
    .ag-status { display:inline-block; padding:3px 10px; border-radius:999px; background:rgba(26,111,168,.12); color:var(--brand,#1a6fa8); font-size:11px; font-weight:600; }
</style>
